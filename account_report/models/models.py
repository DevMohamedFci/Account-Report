...
# class account_report(models.Model):
#     _name = 'account_report.account_report'
...
class account_journalcartreport(models.TransientModel):
    ...
    def print_report(self, data,context=None):
        ...
        return self.env['report'].with_context(landscape=True).get_action(self, 'account_report.report_journalcartreport', data=data)

class journalcartreport(models.AbstractModel):

    _name = 'report.account_report.report_journalcartreport'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('account_report.report_journalcartreport', docargs)
...
class account_CutomerTransactionreport(models.TransientModel):
    ...
    def print_report(self, data,context=None):
        data['form']=self.read(['nid','name','date_from','date_end'])[0]
        return self.env['report'].with_context(landscape=True).get_action(self, 'account_report.report_cutomertransactionreport', data=data)

class CutomerTransactionreport(models.AbstractModel):

    _name = 'report.account_report.report_cutomertransactionreport'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('account_report.report_cutomertransactionreport', docargs)
...
class account_customerbalancereport(models.TransientModel):
    ...
    def print_report(self, data,context=None):
        ...
        return self.env['report'].with_context(landscape=True).get_action(self, 'account_report.report_cbr', data=data)

class customerbalancereport(models.AbstractModel):

    _name = 'report.account_report.report_cbr'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('account_report.report_cbr', docargs)
...
class account_vendorbalancereport(models.TransientModel):
    ...
    def print_report(self, data,context=None):
        data['form']=self.read(['date_from','date_end'])[0]
        return self.env['report'].with_context(landscape=True).get_action(self, 'account_report.report_vbr', data=data)

class vendorbalancereport(models.AbstractModel):

    _name = 'report.account_report.report_vbr'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('account_report.report_vbr', docargs)
